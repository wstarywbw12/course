              ...
              0 < r
                ...
                : ((n = t.from_id == m ? " right" : " left"),
                  ...
                  (n =
                    ...
                    u(t.id, t.msg, t.has_images, t.has_files, t.has_dropDown)),
                  a[e + 1] &&
                    t.from_id == a[e + 1].from_id &&
                    ((r = (function (e, t, s) {
                      for (
                        var n = 0;
                        e[t] && e[t + 1] && e[t + 1].from_id == s;
    ...
    null !== e
      ...
      : (t[0].users.forEach(function (e, t) {
          var s = e.profile
            ...
            n = e.messagecount
              ? '<div class="ms-auto"><span class="badge bg-dark-subtle text-body rounded p-1">' +
                e.messagecount +
                "</span></div>"
              : "",
            a = e.messagecount
            ...
            document
              ...
              .forEach(function (e) {
                t
                  ...
                  : e.querySelector("img").setAttribute("src", r);
              }),
            window.stop();
        });
      }),

        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="title" value="{{ $userTitle }}" disabled>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        ...
                        @if (auth()->user()->foto)
                            <img src="{{ asset('public/storage/' . auth()->user()->foto) }}" width="100"
                                class="rounded mb-2 d-block" id="previewImage">
                        @else
                            <img src="https://via.placeholder.com/100" width="100" class="rounded mb-2 d-block"
                                id="previewImage">
                        @endif
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            <input type="password" name="password_lama" id="password_lama" class="form-control" disabled>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            <input type="password" name="password_baru" id="password_baru" class="form-control" disabled>
                            <span class="input-group-text" style="cursor:pointer;"

...
<div class="container pb-5 quiz-container d-none"
            ...
            <div class="card shadow-sm question-item {{ $qIndex == 0 ? '' : 'd-none' }}"
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex mb-4">
                        <div class="question-number btn btn-primary d-flex align-items-center justify-content-center">
                            {{ $qIndex + 1 }}
                        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function initQuiz(container) {
        ...
        steps.forEach((step, index) => {
            step.addEventListener('click', () => showQuestion(index));
        });

        // NEXT
        container.querySelectorAll('.btn-next').forEach(btn => {
            btn.addEventListener('click', () => showQuestion(current + 1));
        });
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    Swal.fire({
        ...
        text: result.passed
            ? 'Skor kamu ' + result.score + '%'
            : 'Skor kamu ' + result.score + '%. Minimal 70%',
        confirmButtonColor: '#0d6efd'
    });
